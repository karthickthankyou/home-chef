...
const primaryPallete = {
  DEFAULT: `hsl(${brandHue}, 99%, 40%)`,
  25: `hsl(${brandHue}, 99%, 98%)`,
  50: `hsl(${brandHue}, 99%, 90%)`,
  100: `hsl(${brandHue}, 99%, 80%)`,
  200: `hsl(${brandHue}, 99%, 70%)`,
  300: `hsl(${brandHue}, 99%, 60%)`,
  400: `hsl(${brandHue}, 99%, 50%)`,
  500: `hsl(${brandHue}, 99%, 40%)`,
  600: `hsl(${brandHue}, 99%, 30%)`,
  700: `hsl(${brandHue}, 99%, 20%)`,
  800: `hsl(${brandHue}, 99%, 10%)`,
  900: `hsl(${brandHue}, 99%, 04%)`,
}
const grayPallete = {
  DEFAULT: `hsl(${brandHue}, 10%, 32%)`,
  25: `hsl(${brandHue}, 10%, 95%)`,
